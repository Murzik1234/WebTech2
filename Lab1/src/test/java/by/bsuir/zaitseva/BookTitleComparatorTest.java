...
public class BookTitleComparatorTest {
    ...
    @Test
    public void testCompare_SameTitle() {
        ...
        assertEquals(0, result, "Books with the same title should be considered equal.");
    }
    ...
    public void testSortingWithComparator() {
        ...
        books.add(new Book("B", "Author1", 20, "ISBN1"));
        books.add(new Book("A", "Author2", 30, "ISBN2"));
        books.add(new Book("C", "Author3", 25, "ISBN3"));
